...
object Util {
    ...
    private var subApi:String = ""
    private var subFile:String = ""

    fun updateHostSubFile(host:String = "", subApi:String = "", subFile:String = ""){
        this.host = host
        this.subApi = subApi
    ...
    fun getHost() = host
    fun getSubApi() = subApi
    fun getSubFile() = subFile
