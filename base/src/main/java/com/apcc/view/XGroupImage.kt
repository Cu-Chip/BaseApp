...
class GroupImage: ConstraintLayout, ViewInterface {
    ...
    override fun initView(root: View) {
        txtMore = root.findViewById(R.id.apccMore)
        btnAddImage = root.findViewById(R.id.apccAddImage)
        ic1 = root.findViewById(R.id.apccIc1)
        ic2 = root.findViewById(R.id.apccIc2)
        ic3 = root.findViewById(R.id.apccIc3)
        ic4 = root.findViewById(R.id.apccIc4)
        ic5 = root.findViewById(R.id.apccIc5)
        ic6 = root.findViewById(R.id.apccIc6)
        ic7 = root.findViewById(R.id.apccIc7)
        ic8 = root.findViewById(R.id.apccIc8)
        ic9 = root.findViewById(R.id.apccIc9)
        ic10 = root.findViewById(R.id.apccIc10)
        ic11 = root.findViewById(R.id.apccIc11)
        ic12 = root.findViewById(R.id.apccIc12)
