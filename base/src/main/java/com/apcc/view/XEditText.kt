...
class XEditText : EditText, ViewInterface, TextInterface {
    ...
    override fun extraTypes(typedArray: TypedArray) {
        mTextType =
            ViewHelper.getInteger(typedArray, R.styleable.XEditText_textType, TextType.TEXT_NORMAL)
        mTextColorResource = ViewHelper.getResourceId(
            typedArray,
            R.styleable.XEditText_android_textColor,
            R.color.txt_tint
        )
        mHintColorResource = ViewHelper.getResourceId(
            typedArray,
    ...
    override fun updateView() {
        ...
        compoundDrawablePadding = ResourceHelper.getDimension(context, R.dimen.margin_small).toInt()
    }
    //////////////////////////////////////////////////
    /// function support
    //////////////////////////////////////////////////
