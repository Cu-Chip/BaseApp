...
class XRepeat: LinearLayout, ViewInterface {
    ...
    override fun extraTypes(typedArray: TypedArray) {
        mEnable = ViewHelper.getBoolean( typedArray, R.styleable.XRepeat_android_enabled, true)
        repeatType = ViewHelper.getInt( typedArray, R.styleable.XRepeat_repeatType, RepeatType.NONE)
    }
    ...
    override fun initView(root: View) {
        ...
        rbtNone = root.findViewById(R.id.apccNone)
        rbtDaily = root.findViewById(R.id.apccDaily)
        rbtWeekly = root.findViewById(R.id.apccWeekly)
        rbtMonthly = root.findViewById(R.id.apccMonthly)
        rbtYearly = root.findViewById(R.id.apccYearly)
